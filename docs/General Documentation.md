...
You can also free up memory manually: (let ((a (nnl2.hli.ts:zeros #(1)))) ... (nnl2.hli.ts:free a))
...
I'm too lazy to write more documentation, so it ends here. You can find code examples in docs/examples
