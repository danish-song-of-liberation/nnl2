...
;; Filepath: nnl2/tests/ts/ts-tests-activation-functions-inplace.lisp
;; File: ts-tests-activation-functions-inplace.lisp

;; The file is essentially a continuation of the file 
;; `ts-tests-activation-functions.lisp` (in the same folder) 
;; and implements the same (activation functions) but in-place
...
(fiveam:test nnl2.hli.ts/.relu!/float64/1
  (check-nnl2.hli.ts/trivial-operation :dtype :float64 :shape *default-.relu!-operation-shape* :val -1.0d0 :expected 0.0d0 :op #'nnl2.hli.ts:.relu! :inplace t))					
	
(fiveam:test nnl2.hli.ts/.relu!/float64/2
  (check-nnl2.hli.ts/trivial-operation :dtype :float64 :shape *default-.relu!-operation-shape* :val 1.0d0 :expected 1.0d0 :op #'nnl2.hli.ts:.relu! :inplace t))						
	
(fiveam:test nnl2.hli.ts/.relu!/float32/1
  (check-nnl2.hli.ts/trivial-operation :dtype :float32 :shape *default-.relu!-operation-shape* :val -1.0s0 :expected 0.0s0 :op #'nnl2.hli.ts:.relu! :inplace t))	

(fiveam:test nnl2.hli.ts/.relu!/float32/2
  (check-nnl2.hli.ts/trivial-operation :dtype :float32 :shape *default-.relu!-operation-shape* :val 1.0s0 :expected 1.0s0 :op #'nnl2.hli.ts:.relu! :inplace t))	  

(fiveam:test nnl2.hli.ts/.relu!/int32/1
  (check-nnl2.hli.ts/trivial-operation :dtype :int32 :shape *default-.relu!-operation-shape* :val -1 :expected 0 :op #'nnl2.hli.ts:.relu! :inplace t))			
  
(fiveam:test nnl2.hli.ts/.relu!/int32/2
  (check-nnl2.hli.ts/trivial-operation :dtype :int32 :shape *default-.relu!-operation-shape* :val 1 :expected 1 :op #'nnl2.hli.ts:.relu! :inplace t))	
  
;; -- `.leaky-relu!` tests section --		
	
(fiveam:test nnl2.hli.ts/.leaky-relu!/float64/1
  (check-nnl2.hli.ts/trivial-operation :dtype :float64 :shape *default-.leaky-relu!-operation-shape* :val -1.0d0 :expected (coerce -0.01 'double-float) :op #'nnl2.hli.ts:.leaky-relu! :tolerance 0.001 :inplace t))					
	
(fiveam:test nnl2.hli.ts/.leaky-relu!/float64/2
  (check-nnl2.hli.ts/trivial-operation :dtype :float64 :shape *default-.leaky-relu!-operation-shape* :val 1.0d0 :expected 1.0d0 :op #'nnl2.hli.ts:.leaky-relu! :inplace t))						
	
(fiveam:test nnl2.hli.ts/.leaky-relu!/float32/1
  (check-nnl2.hli.ts/trivial-operation :dtype :float32 :shape *default-.leaky-relu!-operation-shape* :val -1.00 :expected -0.01 :op #'nnl2.hli.ts:.leaky-relu! :tolerance 0.001 :inplace t))	

(fiveam:test nnl2.hli.ts/.leaky-relu!/float32/2
  (check-nnl2.hli.ts/trivial-operation :dtype :float32 :shape *default-.leaky-relu!-operation-shape* :val 1.0s0 :expected 1.0s0 :op #'nnl2.hli.ts:.leaky-relu! :inplace t))	  
  
(fiveam:test nnl2.hli.ts/.leaky-relu!/int32
  (check-nnl2.hli.ts/trivial-operation :dtype :int32 :shape *default-.leaky-relu!-operation-shape* :val -100 :expected -1 :op #'nnl2.hli.ts:.leaky-relu! :inplace t))	
    
(fiveam:test nnl2.hli.ts/.leaky-relu!/int32/3
  (check-nnl2.hli.ts/trivial-operation :dtype :int32 :shape *default-.leaky-relu!-operation-shape* :val 1 :expected 1 :op #'nnl2.hli.ts:.leaky-relu! :inplace t))	
