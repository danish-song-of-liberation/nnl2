...
void nnl2_ad_reverse_backward_sub_correspondence(nnl2_ad_tensor* tensor) {
    nnl2_ad_reverse_derivative_sub_correspondence(tensor, tensor->roots[0], tensor->extra_correspondence);
}   

nnl2_ad_tensor* nnl2_ad_sub_correspondence(nnl2_ad_tensor* tensor, void* dec, nnl2_ad_mode ad_mode) {
    ...
    switch(ad_mode) {
        case nnl2_ad_reverse_mode: result->backward_fn = nnl2_ad_reverse_backward_sub_correspondence; break;
