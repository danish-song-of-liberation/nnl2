...
nnl2_ad_tensor* nnl2_ad_add_correspondence(nnl2_ad_tensor* tensor, void* inc, nnl2_ad_mode ad_mode) {
	...
	switch(ad_mode) {
		case nnl2_ad_reverse_mode: result->backward_fn = nnl2_ad_reverse_backward_add_correspondence; break;
