...
nnl2_ad_tensor* nnl2_ad_min_correspondence(nnl2_ad_tensor* tensor, void* threshold, nnl2_ad_mode ad_mode) {
    ...
    switch(ad_mode) {
        case nnl2_ad_reverse_mode: result->backward_fn = nnl2_ad_reverse_backward_min_correspondence; break;
