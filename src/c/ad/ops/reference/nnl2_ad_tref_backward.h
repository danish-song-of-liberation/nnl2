 ...
 *
 ** @param scalar_exit_p
 * Boolean indicating if the operation resulted in a scalar
 *
 ** @exception NNL2Error
 * If any tensor is NULL, function returns early
 */
static void nnl2_ad_reverse_derivative_tref_getter(nnl2_ad_tensor* tref_tensor, nnl2_ad_tensor* original_tensor, int32_t* indices, uint8_t num_indices, bool scalar_exit_p) {
