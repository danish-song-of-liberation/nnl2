...
nnl2_ad_tensor* nnl2_ad_div(nnl2_ad_tensor* dividend, nnl2_ad_tensor* divisor, nnl2_ad_mode ad_mode, bool track_graph) {
    ...
    switch (ad_mode) {
        case nnl2_ad_reverse_mode:
            result->backward_fn = nnl2_ad_reverse_backward_div;
            break;
