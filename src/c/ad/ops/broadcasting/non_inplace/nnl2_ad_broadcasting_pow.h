...
nnl2_ad_tensor* nnl2_ad_pow_broadcasting(nnl2_ad_tensor* base, nnl2_ad_tensor* exponent, nnl2_ad_mode ad_mode) {
    //not ready
    ...
    switch(ad_mode) {
        case nnl2_ad_reverse_mode: result->backward_fn = nnl2_ad_reverse_backward_pow_broadcasting; break;
