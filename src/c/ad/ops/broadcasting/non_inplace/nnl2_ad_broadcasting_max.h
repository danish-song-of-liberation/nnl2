...
void nnl2_ad_reverse_backward_max_broadcasting(nnl2_ad_tensor* tensor) {
    nnl2_ad_reverse_derivative_max_broadcasting(tensor, tensor->roots[0], tensor->roots[1]);
}   

nnl2_ad_tensor* nnl2_ad_max_broadcasting(nnl2_ad_tensor* tensor_a, nnl2_ad_tensor* tensor_b, nnl2_ad_mode ad_mode) {
    //not ready
