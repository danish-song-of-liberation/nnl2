...
void nnl2_ad_reverse_backward_max_broadcasting_inplace(nnl2_ad_tensor* tensor_a) {
    nnl2_ad_reverse_derivative_max_broadcasting_inplace(tensor_a, tensor_a->roots[0]);
}   

void nnl2_ad_max_broadcasting_inplace(nnl2_ad_tensor* tensor_a, nnl2_ad_tensor* tensor_b, nnl2_ad_mode ad_mode) {
    ...
    switch(ad_mode) {
        case nnl2_ad_reverse_mode: tensor_a->backward_fn = nnl2_ad_reverse_backward_max_broadcasting_inplace; break;
