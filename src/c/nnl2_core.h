...
static inline nnl2_int32 nnl2_relu_int32(nnl2_int32 a) {
	return MAX(a, (nnl2_int32)0);
}

static inline nnl2_int64 nnl2_relu_int64(nnl2_int64 a) {
    return MAX(a, (nnl2_int64)0);
}
...
static inline void nnl2_relu_int64_inplace(nnl2_int64* a) {
    if(*a < 0) *a = 0;
}
...
static inline nnl2_int64 nnl2_leaky_relu_int64(nnl2_int64 a, float alpha) {
    if (a > 0) {
        return a;
    } else {
        return (nnl2_int64)(a * alpha);
    }
}
...
static inline void nnl2_leaky_relu_int64_inplace(nnl2_int64* a, float alpha) {
    if(*a < 0) {
        float result = (*a * alpha);
        float remainder = fmodf(fabsf(result), 1.0f);
