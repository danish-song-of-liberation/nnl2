...
void nnl2_naive_tan_inplace(nnl2_tensor* tensor) {	
    ...
    // Additional checks at the maximum safety level
        ...
        NNL2_CHECK_NULL_IF_ERR_RETURN(tensor, "Tensor is NULL (.tan!)");
        NNL2_CHECK_NULL_IF_ERR_RETURN(tensor->data, "Tensor's data is NULL (.tan!)");
    #endif
 ...
 */
Implementation taninplace_backends[] = {
