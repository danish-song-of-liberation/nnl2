...
void nnl2_naive_sqrt_inplace(nnl2_tensor* tensor) {
	...
	// Additional checks at the maximum safety level
        ...
        NNL2_CHECK_NULL_IF_ERR_RETURN(tensor, "Tensor is NULL (.sqrt!)");
        NNL2_CHECK_NULL_IF_ERR_RETURN(tensor->data, "Tensor's data is NULL (.sqrt!)");
	#endif
 ...
 */
Implementation sqrtinplace_backends[] = {
