...
void nnl2_naive_atan_inplace(nnl2_tensor* tensor) {
    ...
    // Additional checks at the maximum safety level
        ...
        NNL2_CHECK_NULL_IF_ERR_RETURN(tensor, "Tensor is NULL (.atan!)");
        NNL2_CHECK_NULL_IF_ERR_RETURN(tensor->data, "Tensor's data is NULL (.atan!)");
    #endif
 ...
 */
Implementation ataninplace_backends[] = {
