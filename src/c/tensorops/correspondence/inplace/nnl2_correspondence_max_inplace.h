...
/** @brief
 * Worker function for parallel int64 in-place element-wise maximum operation
 * 
 ** @param arg 
 * Pointer to max_maxf_inplace_ptask structure containing thread parameters
 *
 ...
 ** @see nnl2_own_pmax_maxf_inplace_float64
 **/
void* nnl2_own_pmax_maxf_inplace_int64(void* arg);
...
void nnl2_own_max_maxf_inplace(nnl2_tensor* tensor, void* threshold) {
    ...
    for (size_t i = 0; i < num_threads; i++) {
        ...
        switch(dtype) {
			...
			case INT64:   worker_func = nnl2_own_pmax_maxf_inplace_int64;   break;
 ...
 * See documentation at declaration
 * 
 ** @see nnl2_own_pmax_maxf_inplace_int64
 **/
void* nnl2_own_pmax_maxf_inplace_int64(void* arg) {
    max_maxf_inplace_ptask* task = (max_maxf_inplace_ptask*)arg;
