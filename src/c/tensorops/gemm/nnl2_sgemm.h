 ...
 * nnl2_tensor* result = sgemm(nnl2RowMajor, nnl2NoTrans, nnl2NoTrans, m, n, k, alpha, A, lda, B, ldb, beta);
 *
 ** @see sgemminplace()
 **/
nnl2_tensor* sgemm(const nnl2_order order, const nnl2_transpose transa, 
			  const nnl2_transpose transb, const int m, const int n, 
			  const int k, const float alpha, const nnl2_tensor* a, const int lda,
			  const nnl2_tensor* b, const int ldb, const float beta) {
	...
	nnl2_tensor_type type_c = FLOAT32;
