...
/** @file nnl2_optim_free.h
 ** @date 2025
 ** @copyright MIT License
 ** @brief Contains a freeing function
 **/
 
/** @brief 
 * Free an optimizer object of any type
 * 
 ** @param optim 
 * Generic pointer to the optimizer object to free
 */
void nnl2_optim_free(void* optim) {
	...
	switch(*type_optim) {
		case nnl2_optim_type_gd: {
			// Call Gradient Descent optimizer destructor
