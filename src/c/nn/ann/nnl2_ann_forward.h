...
typedef struct nnl2_nn_unirnn_cell_struct nnl2_nn_unirnn_cell;
    ...
    switch(ann -> nn_type) {
        ...
        case nnl2_nn_type_unirnn_cell: {
			...
			nnl2_ad_tensor* hidden = (nnl2_ad_tensor*)safe_args[1];
				...
				NNL2_DEBUG("Dispatching forward to UniRNNCell layer");
			#endif
			
			nnl2_nn_unirnn_cell* cell = (nnl2_nn_unirnn_cell*)model;
