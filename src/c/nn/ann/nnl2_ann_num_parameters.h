...
size_t nnl2_ann_num_parameters(void* nn) {
    ...
    switch(*nn_type) {
		...
		case nnl2_nn_type_rnn: {
            size_t num_params = nnl2_nn_rnn_get_num_parameters(nn);
		...
		case nnl2_nn_type_sigmoid: {
            size_t num_params = nnl2_nn_sigmoid_get_num_parameters(nn);
		...
		case nnl2_nn_type_tanh: {
            size_t num_params = nnl2_nn_tanh_get_num_parameters(nn);
		...
		case nnl2_nn_type_relu: {
            size_t num_params = nnl2_nn_relu_get_num_parameters(nn);
		...
		case nnl2_nn_type_leaky_relu: {
            size_t num_params = nnl2_nn_leaky_relu_get_num_parameters(nn);
		...
		case nnl2_nn_type_softmax: {
            size_t num_params = nnl2_nn_softmax_get_num_parameters(nn);
