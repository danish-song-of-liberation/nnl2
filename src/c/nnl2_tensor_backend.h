...
typedef void (*sumwithoutaxisfn)(Tensor*, void*);
typedef void (*sumwithaxisfn)(Tensor*, int);
typedef void (*l2normfn)(const Tensor*, int*, int);
typedef Tensor* (*copyfn)(const Tensor*, int);
