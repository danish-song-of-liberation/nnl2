...
(defun get-openblas-path (dir-path)
  "returns a filepath to openblas_test
...
(defun get-openblas-status (dir-path include-path lib-path)
  "compiles c file with openblas code
  ...
  (handler-case
      (let* ((path nnl2.intern-system:*current-dir*)
			 (cpath (get-openblas-path dir-path))
